...
def main():
    ...
    numbers, bank_name, transaction_type = process_text(text)

    if numbers or transaction_type:
        if transaction_type:
            add_to_database(numbers, bank_name, transaction_type)
        else:
            print("Transaction type could not be determined.")
    else:
